...
dataldavd00 <- data.frame(ldsvd00[,1], ldsvd00[,2], sizefree_dfvd00.x.pop$Population)

plotldavd00 <- ggplot(dataldavd00, aes(x=ldsvd00...1., y=ldsvd00...2., colour = sizefree_dfvd00.x.pop.Population)) +
...
#ucpm.sizefree_dfvd00.rda <- ucpm(predsizefree_dfvfd00.rda$posterior, factor.sizefree_dfvd00)
