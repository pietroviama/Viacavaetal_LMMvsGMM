...
PCredante <- as.matrix(PCA2d$x[,1:65]) 
...
#GMM data
fit.sizegmm <- procD.lm(f1 = gpaallpop$coords~gpaallpop$Csize, print.progress = FALSE)
...
plot(consensuslms[[1]]~gmeanscon)

plot(log(consensuslms[[1]]/gmeanscon)~log(gmeanscon))
