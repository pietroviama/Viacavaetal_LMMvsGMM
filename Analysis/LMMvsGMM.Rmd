...
plotPCAgmmresiduals <- ggplot(dataPCAgmmresiduals, aes(x=X.PCAgmmresiduals.x...1., y=PCAgmmresiduals.x...2., colour = antechinusdata.Population)) +
...
fitvd00.pop.uni <- procD.lm(sizefree_dfvd00.x.pop[,1:13]~log(gmeansvd00.pop)*antechinusdatapop$Population, effect.type = "F")
summary(fitvd00.pop.uni)
...
plotPCAd98res <- ggplot(dataPCAd98res, aes(x=PCAd98res.x...1., y=PCAd98res.x...2., colour = antechinusdata.Population)) +
